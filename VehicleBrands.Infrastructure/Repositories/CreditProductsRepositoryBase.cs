...
{
    public class CreditProductsRepositoryBase<T> : IAsyncRepository<T> where T : class
    {
        protected readonly CreditProductsDbContext _context;

        public CreditProductsRepositoryBase(CreditProductsDbContext context)
        {
            _context = context;
        }
